              ...
              {(() => {
                ...
                return slots.map((slot) => {
                  ...
                  const isPastSlot =
                    ...
                    (slotHour < nowHours || (slotHour === nowHours && slotMin <= nowMinutes));
                  return (
                    <button
                      key={slot.time}
                      onClick={() => !isPastSlot && slot.available && handleTimeClick(slot.time)}
                      ...
                      title={isPastSlot ? "Horário já passou" : !slot.available ? slot.reason || "Indisponível" : ""}
                    >
                      {slot.time}
                    </button>
                  );
